...
class Figure(metaclass=ABCMeta):
    """Classical superclass - for a demo. It's a abstract class"""
    charVal = 0.0
...
class Rectangle(Figure):
    """Classical child - a square - a typical figure"""
...
class Square(Rectangle):
    ...
    def getPerimeter(self): return Rectangle.getPerimeter(self)


class Circle(Figure):
    """Classical child - a circle - a typical figure"""
    def __init__(self,characteristicValue:float=1.0):
        self.charVal = float(characteristicValue)
        print("Class: '",Circle.__name__,"' initialized with",self.charVal,"as a radius")
    def getPerimeter(self): return 2*math.pi*self.charVal
    def getArea(self): return math.pi*math.pow(self.charVal,2)

# %% Testing scripts
characteristicValue = 2 # Size of figures
sq1 = Square(characteristicValue); print("Perimeter of a square",sq1.getPerimeter())
